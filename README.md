...
Лицензия пока не добавлена. Если репозиторий будет использоваться публично - будет добавлена `Licence` в ближайшее время данный вопрос затрагиваться не будет.
